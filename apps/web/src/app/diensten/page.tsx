  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-12 md:py-16">
      <div className="max-w-2xl">
        <p className="text-sm font-medium text-primary-600 dark:text-primary-400">Wat ik doe</p>
        <h1 className="mt-2 text-3xl font-bold tracking-tight md:text-4xl">Diensten</h1>
